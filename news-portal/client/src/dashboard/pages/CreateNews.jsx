...
//     // 👇 Yahan par MAIN CHANGE kiya hai 👇
//     const imageHandler = async (e) => {
//         const files = e.target.files
//         try {
//             const formData = new FormData()
...
//             // ❌ PURANA CODE (Jo Error de raha tha - Nested Array bana raha tha)
//             // setImages([...images, data.images]) 

//             // ✅ NYA SAHI CODE (Spread operator sahi se use kiya)
//             // Hum check kar rahe hain ki backend array bhej raha hai ya single object
...
//             <form onSubmit={added} className='space-y-8'>
...
//         // Sirf English, Number, Hindi (\u0900-\u097F) aur Dash (-) allow karo
//         return text
//             .trim()
//             .toLowerCase()
...
//         setTitle(val);
//         // Title ke sath-sath Slug bhi auto-update karo
...
//         const formData = new FormData();
//         formData.append('title', title);
//         formData.append('slug', slug); // NEW: Slug bhejo backend ko
//         formData.append('description', description);
//         formData.append('image', image);
...
const CreateNews = () => {
    ...
    const categories = [
        'Sports', 'Politics', 'Entertainment', 'Technology', 'Health', 'Education', 'Travel'
    ];
